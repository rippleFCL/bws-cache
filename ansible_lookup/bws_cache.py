...
from ansible.errors import AnsibleError, AnsibleUndefinedVariable  # type: ignore # noqa: E402
from ansible.module_utils.common.text.converters import to_text  # type: ignore # noqa: E402
...
class BwsCacheLookup:
    ...
    def query_secret_key(self, secret_key: str):
        ...
        response = requests.get(
            f"{self.bws_cache_url}/key/{secret_key}", headers=self.headers, timeout=5
        )
        return response
